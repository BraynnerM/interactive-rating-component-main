...
Esta é uma solução para o desafio do Frontend Mentor [Interactive rating component main challenge on Frontend Mentor](https://www.frontendmentor.io/challenges/interactive-rating-component-koxpeBUmI/hub). Os desafios do Frontend Mentor ajudam a melhorar minhas habilidades de codificação criando projetos realistas.
...
- URL da solução: [Github](https://github.com/BraynnerM/interactive-rating-component-main)
-  URL do site no Github Pages: [Results summary component](https://braynnerm.github.io/interactive-rating-component-main/)
